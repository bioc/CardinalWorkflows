...
```{r top-liver}
subset(pig206_top, class==6 & statistic > 0)
```

Peaks associated with the brain:

```{r top-brain}
subset(pig206_top, class==7 & statistic > 0)
```
...
pal <- c("1"=NA, "2"=NA, "3"="gray", "4"="black",
	"5"="black", "6"="firebrick", "7"="red", "8"="darkred")
...
image(cardinal_peaks, mz=649.15, smooth="guided", enhance="histogram")
```
